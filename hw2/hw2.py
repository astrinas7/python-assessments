...
def askisi9():
    ...
    def circ(a):
    	return "Emvado kyklou aktinas " + str(a) + " = " + str(math.pi * a**2)

    def print_list(max_i, initial_print, funct):
        print(initial_print, end = "")	
        [print(funct(i)) for i in range(1, max_i + 1)]

    func_list = (lambda x: 2 * math.pi * x ,lambda x: x * x, circ)

    print_list(10, "Perifereies kyklwn me aktina 1 ews 10\n", func_list[0])
    print_list(10, "Emvada tetragwnwn me pleura 1 ews 8\n", func_list[1])
    print_list(10, "",func_list[2])
